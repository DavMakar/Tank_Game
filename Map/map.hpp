...
class Map{
    ...
    public:
        enum Map_title{empty = 0, boundary = 1 , wall = 2,  bullet = 3, player = 1 , enemy = 4};
    ...
    private:
        bool bullet_collision_tank(int bullet_x,int bullet_y,const int bullet_size , int tank_x ,int tank_y ,const int tank_size);
        bool is_moveable_object(const int matrix_element);
        void add_boundaries();
        void add_walls();
};
